...
export async function GET(req:NextRequest,{params}:Ctx){return memberResult(async()=>{
...
export async function PUT(req:NextRequest,{params}:Ctx){return memberResult(async()=>{
...
export async function DELETE(req:NextRequest,{params}:Ctx){return memberResult(async()=>{

...
type Context = { params: { ticket_id: string } };
...
export function GET(req: NextRequest, { params }: Context) { return handled(async () => {
...
export function POST(req: NextRequest, { params }: Context) { return handled(async () => {

...
test('member sidebar renders the current destinations in order; removed links retain their pages', () => {
  ...
  expect(links).toEqual(['/member/dashboard','/member/workouts','/member/nutrition','/member/bookings','/member/health','/member/rewards','/member/wearables','/member/account','/member/account/support']);
